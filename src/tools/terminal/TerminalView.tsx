...
export function TerminalView() {
  ...
  // The search UI itself is native and pane-local. This bridge only covers
  // Cmd+F while the terminal rail/WebView owns focus; native-pane focus goes
  // straight through Ghostty's key binding.
  useShortcut("mod+f", () => {
    void terminalSearch("start").catch((error) =>
      console.error("[terminal] start native search failed:", error),
    );
  }, true, { fireInInputs: true });
