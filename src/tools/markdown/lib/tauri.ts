...
// Pure POSIX path helpers — re-exported from `@zen-tools/types` so
// every consumer of `markdown/lib/tauri` keeps working without churn,
// while the canonical implementations now live in the shared package.
export {
  basename,
  basenameNoExt,
  dirname,
