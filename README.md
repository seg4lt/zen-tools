...
A modular Tauri 2 desktop app hosting six developer tools, each
selectable from a segmented-pill in the title bar:

- **HTTP runner** — IntelliJ-style `.http` / `.rest` editor + runner
...
- **Database Explorer** — DataGrip-lite: Postgres + MSSQL, schema
  cache with autocomplete, explain-plan visualiser, lock telemetry.
