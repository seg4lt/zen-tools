...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::prmaster::prmaster_list_issue_comments,
            ...
            commands::pr_review::prmaster_ai_review_resolve_worktree_path,
            ...
            commands::git::git_pick_and_add_repo,
            commands::git::git_remove_repo,
            commands::git::git_relabel_repo,
            commands::git::git_list_commits,
            commands::git::git_count_commits,
            commands::git::git_list_branches,
            commands::git::git_list_authors,
            ...
            commands::git::git_write_resolved,
            commands::git::git_stage_path,
            commands::git::git_unstage_path,
            commands::git::git_preview_merge,
            commands::git::git_continue_op,
            commands::git::git_abort_op,
            commands::git::git_skip_op,
